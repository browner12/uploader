...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The default filesystem disk to be used for uploads. This disk should be
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Set if optimized images will be created when an image is uploaded.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Set if thumbnails will be created when an image is uploaded.
    |
    */
